...
function about() {
  return (
    <>
      <Head>
        <title>Shemil | About Page</title>
        <meta name="description" content="any desc" />
      </Head>
      <TransitionEffect />
      <main className="flex flex-col items-center justify-between w-full pb-80 dark:text-light">
        <Layout className={"pt-2"}>
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8 ">
            ...
            <div className="relative col-span-3 p-8 border-2 xl:col-span-4 h-max rounded-2xl border-dark bg-light md:order-1 md:col-span-8">
            ...
            <div className="flex flex-col items-end justify-between col-span-2 xl:col-span-8 xl:flex-row xl:items-cente md:order-3">
